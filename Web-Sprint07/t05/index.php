...
<head>
    ...
    <style>
    table {border: 1px double gray; width: 100%;}
    table th, table td {border: 1px double black; padding: 2px;}
    </style>
</head>
...
<body>
    ...
    if (isset($_SESSION["file"])) {
        ...
        echo "Filter: ".$filter_str.'<button>APPLY</button></form>';
    }
    ?>
    ...
    <?php
        ...
        foreach($head_text as $elem) { 
            $head_str = $head_str . '<form  method="post"> <td> <button name = "'. $elem .'">' . $elem . " </button> </td> </form>";
        }
